...
FUNCTION_NAME=LambdaSglApiParceirosProcessorTest
HANDLER=io.quarkus.amazon.lambda.runtime.QuarkusStreamHandler::handleRequest
RUNTIME=java11
ZIP_FILE=fileb:///C:/git/poc-aws-puc-minas-pos-arq-soft-dist-max-back/lambda-sgl-api-parceiros-processor-test/target/function.zip
...
then
  RUNTIME=provided
  ZIP_FILE=fileb:///C:/git/poc-aws-puc-minas-pos-arq-soft-dist-max-back/lambda-sgl-api-parceiros-processor-test/target/function.zip
  FUNCTION_NAME=LambdaSglApiParceirosProcessorTestNative
